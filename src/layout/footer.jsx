    ...
    <div className="w-full mt-8">
      <footer className="footer items-center p-4 bg-base-200">
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a target="_blank" href="https://www.instagram.com/nhsmatholy/">
            <svg
          ...
          <a target="_blank" href="https://discord.gg/4EszajaUHx">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a
            target="_blank"
            href="https://drive.google.com/drive/folders/1qVQu6YcAbRuEj1vFb39SiI3za9wK7FAG?usp=sharing"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
